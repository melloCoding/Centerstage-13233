...
//@Autonomous(name = "AutoAllWithTF3cones ", group = "")

public class AutoAllWithTF3cones extends LinearOpMode {
    ...
    */
    ...
    private static int posSecondCone = -900;
   ...
   public void runOpMode() throws InterruptedException {
    ...
    private void RightAuto() {
       ...
       //driveBack(1.0, quarterPower);
       strafeLeft(16.0, halfPower);
       sliderPosition(posBottom,sleepTimeNone);

       //drive forward to line up with stacked cones
       driveForward(58.0, halfPower);
